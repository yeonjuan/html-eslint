---
title: svelte/no-restricted-tags
description: Disallow specified tags in Svelte components based on custom configuration.
---

# no-restricted-tags

This rule disallows the use of specified tags in Svelte components.
...
export default [
  {
    ...
    rules: {
      "@html-eslint/svelte/no-restricted-tags": [
        "error",
        {
